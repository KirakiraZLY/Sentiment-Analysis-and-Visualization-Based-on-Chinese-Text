...
class Pos_WordCloud(QtWidgets.QMainWindow):
    def __init__(self):
        super(Pos_WordCloud, self).__init__()
        self.setupUi(self)
    ...
    def setupUi(self, MainWindow):
        ...
        png = QtGui.QPixmap('./pics/pos_cloud.jpg')
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "正向情感词云"))
